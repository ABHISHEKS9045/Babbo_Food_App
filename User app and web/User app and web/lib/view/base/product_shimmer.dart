...
class ProductShimmer extends StatelessWidget {
  ...
  const ProductShimmer({Key? key, required this.isEnabled, required this.hasDivider, this.isRestaurant = false}) : super(key: key);
              ...
              child: Row(children: [
                ...
                Expanded(
                  child: Column(crossAxisAlignment: CrossAxisAlignment.start, mainAxisAlignment: MainAxisAlignment.center, children: [
                    ...
                    !isRestaurant ? RatingBar(rating: 0, size: desktop ? 15 : 12, ratingCount: 0) : const SizedBox(),
